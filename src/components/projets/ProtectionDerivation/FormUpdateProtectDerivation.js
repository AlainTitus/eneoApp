...
const FormUpdateProtectDerivation = ({ derivationToUpdate, setTableVisible, setFormVisible,token }) => {
    ...
    const onSubmit = values => {
        ...
        fetch('http://localhost:5500/miseajoutderivation',
            {
                method: 'POST',
                headers: {
    ...
    return (
        <Paper style={{ padding: '8px', marginTop: '5px' }}>
            ...
            <Formik
                initialValues={derivationToUpdate || initialValues}
...
export default FormUpdateProtectDerivation
